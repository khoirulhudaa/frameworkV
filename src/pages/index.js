      ...
      <main>
        ...
        <div className="absolute w-full h-full overflow-hidden">
          ...
          <div className='relative w-full h-[80vh] text-center mx-auto flex flex-col justify-center items-center'>
            ...
            <h1 className='text-[3.7rem] font-bold w-[80vw] text-center'>
              Build modern website easily <br /> no CSS required.
            </h1>
            <p className='text-slate-500 w-[50%]'>A utility-first CSS framework packed with classes like v-pt-4, <span className='bg-blue-400 text-white rounded-full h-max pb-[2px] text-[14px] px-2'>v-d-flex</span>, text-center and rotate-90 that can be composed to build any design, directly in your code.</p>
            <Link to={'/docs/getStarted'}>
              <div className='relaative no-underline mt-4 px-14 py-2.5 font-medium text-[15px] bg-blue-500 text-white rounded-full cursor-pointer'>
            ...
            <div className='text-[14px] mt-6 w-max flex items-center mx-auto'>
              <div className='w-max flex items-center px-3 py-1.5 rounded-full text-red-500 bg-red-100'>
                <EthereumRectangleIcon className='w-4 h-4 relative mr-2' />
                Utilities
              </div>
              <div className='w-max mx-4 flex items-center px-3 py-1.5 rounded-full text-purple-500 bg-purple-100'>
                <Blockchain04Icon className='w-4 h-4 relative mr-2' />
                Components
              </div>
              <div className='w-max flex items-center px-3 py-1.5 rounded-full text-green-500 bg-green-100'>
        ...
        <div className='w-[90vw] mx-auto h-[0.6px] bg-slate-300 mb-4'></div>
        
        <div className='flex mx-auto w-[90vw] text-justify'>
          ...
          <div className='w-[1px] bg-slate-300 h-[200px] mx-3'></div>
          <div className='w-1/2 h-max p-3'>
        ...
        <div className='relative w-[80vw] h-max mt-16 mb-11 mx-auto flex flex-col items-center justify-center'>
          <div className='w-full flex flex-col text-center items-center justify-center'>
              ...
              <p className='text-slate-500 w-[50%] mt-5 text-[12px]'>
        ...
        <footer className='w-full h-[48px] flex items-center justify-center'>

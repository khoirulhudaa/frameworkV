    ...
    >
      <main className='ooverflow-x-hidden w-screen'>
        ...
        <div className='relative w-full h-full flex justify-center'>
          ...
          <div className='relative w-full mt-0 h-max lg:h-[80vh] text-center mx-auto flex flex-col justify-center items-center'>
            <div className='lg:rounded-full flex bg-blue-100 lg:text-[16px] text-[13px] text-blue-400 h-max w-full lg:w-max px-3 py-3 lg:py-1 mb-6 lg:mb-2 items-center justify-center'>
            ...
            <p className='text-slate-500 lg:text-[16px] text-[14px] w-[90%] lg:w-[50%]'>A utility-first CSS framework packed with classes like v-pt-4, <span className='bg-transparent lg:bg-blue-400 lg:text-white rounded-full h-max pb-[2px] text-[14px] lg:px-2'>v-d-flex</span>, text-center and rotate-90 that can be composed to build any design, directly in your code.</p>
            <Link to={'/docs/getStarted'}>
              <div className='relaative lg:w-max w-[60vw] no-underline mt-4 px-4 lg:px-14 py-3 lg:py-2.5 font-medium text-[14px] lg:text-[15px] bg-blue-500 text-white rounded-md lg:rounded-full cursor-pointer'>
                Get started <LaptopProgrammingIcon className='ml-1 w-4 h-4 relative top-[1.5px]' />
              </div>
            </Link>

            <div className='text-[14px] mt-6 w-[100vw] lg:w-max flex items-center mx-auto'>
              <div className='w-full lg:w-[30%] justify-center flex items-center px-3 py-3 lg:py-1.5 lg:rounded-full text-red-500 bg-red-100'>
                <EthereumRectangleIcon className='w-4 h-4 relative mr-2 lg:inline hidden' />
                Utilities
              </div>
              <div className='w-full lg:w-[30%] justify-center lg:mx-4 flex items-center px-3 py-3 lg:py-1.5 lg:rounded-full text-purple-500 bg-purple-100'>
                <Blockchain04Icon className='w-4 h-4 relative mr-2 lg:inline hidden' />
                Components
              </div>
              <div className='w-full lg:w-[30%] justify-center flex items-center px-3 py-3 lg:py-1.5 lg:rounded-full text-green-500 bg-green-100'>
        ...
        <footer className='w-full h-[48px] text-slate-500 lg:text-[14px] text-[14px] flex items-center justify-center'>
